...
* *Image 6* was classified wrongly by the model. The sign was a "trucks over 3.5 metric tons prohibited sign" and it was classified as "Roundabout Mandatory" with a 92% confidence! This model with a slightly different orientation looks pretty clear with ideal lighting conditions and initially I couldn't figure out why it the model classifying this wrongly. However, looking at the training dataset histograms, the number of input images for the "trucks prohibited" sign may not have been enough for the model to learn its unique characteristics properly. This suggests that data augmentation might have helped some.
